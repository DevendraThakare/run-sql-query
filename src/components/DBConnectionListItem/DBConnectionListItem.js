...
const DBConnectionListItem = (props) => {
    ...
    return <div className="px-4 py-4 border-b border-slate-200 bg-slate-100">
        ...
        <div className="flex flex-row justify-between">
            ...
            {connection.status === 'disconnected' ? <div className="text-green-700 font-semibold text-xs cursor-pointer">Connect</div>
